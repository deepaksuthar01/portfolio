        ...
        <section className=" w-full  py-16 bg-yellow-500">
            <div className="container-xl">
                ...
                <div className="flex gap-10 max-lg:flex-col">
                    <div className="lg:w-1/3 shadow-md p-5 rounded-lg shadow-black ">
                    ...
                    <div className="lg:w-2/3 shadow-md p-5 rounded-lg shadow-black">
                        <h3 className="text-2xl font-semibold mb-8">Say Something</h3>
                        <form action="#">
                            <div className="flex gap-5 mb-3">
                                <input type="text" className="p-2 w-1/2" placeholder="Name*" />
                                <input type="email" className="p-2 w-1/2" placeholder="Email*" />
                            </div>
                            <input type="text" className="p-2 w-full mb-3" placeholder="Subject*" />
                            <textarea placeholder="Your Message*" className="p-2 w-full mb-3" rows={5}></textarea>
                            <button type="button" className="site-btn rounded-md bg-black text-white hover:text-white">Send Message</button>
                        </form>
                    </div>
                </div>
